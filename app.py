...
# ai_edge_litert is the actively-maintained successor to tflite_runtime
# (Google renamed "TensorFlow Lite" to "LiteRT" in 2024, and tflite-runtime
# stopped getting new wheels published — this is the modern replacement,
# same lightweight footprint, same API).
try:
